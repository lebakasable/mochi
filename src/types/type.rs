...
/// Representation of Types within Mochi.
///
...
impl Type {
    ...
    pub fn type_check_functions(
        ...
        {
            let fns = types
                .extract_if(|_, v| matches!(v, Type::UncheckedFunction { .. }))
    ...
    pub fn try_generic_function(&self, token: &Token) -> Result<&GenericFunction, MocError> {
