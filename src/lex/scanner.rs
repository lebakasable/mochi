...
impl Scanner {
    ...
    pub fn scan_tokens(mut self) -> Result<Vec<Token>, MocError> {
    ...
    fn scan_token(&mut self) -> Result<(), MocError> {
        let c = self.advance();
        match c {
    ...
    fn string(&mut self) -> Result<(), MocError> {
    ...
    fn char(&mut self) -> Result<(), MocError> {
    ...
    fn number(&mut self) -> Result<(), MocError> {
    ...
    fn identifier(&mut self) -> Result<(), MocError> {
    ...
    fn syscall(&mut self) -> Result<(), MocError> {
        if !self.matches('(') {
            return Err(MocError::new(
