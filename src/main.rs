...
//! # Mochi
//!
//! Mochi is a compiled, staticaly typed, stack based programming language
//! with opt-in variable assignment for improved ergonomics. This is it's
//! compiler!
//!
//! ```mochi
//! fn main() {
//!     "Welcome to the Mochi compiler!" println
//! }
//! ```
//!
//! # Compilation Stages
//! To compile a `Mochi` program from an input file into the generated
//! assembly, the compiler transforms the data between representations a number
//! of times.
//!
//! At a high level, the process looks like this:
//! 1. Input `.moc` file is read and converted into tokens (lexing/scanning).
...
//! instructions are a closer representation of what `Mochi` does under the
//! hood.
//!
//! More work should be done to generalize these backend instructions, which
//! would make it easier to create implementations of `Mochi` for other
//! targets.
//!
//! ## Code Generation
