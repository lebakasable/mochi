...
pub fn run_command(
    ...
    match Command::new(cmd).args(args).output() {
        ...
        Err(e) => Err(
            MocError::new("Command Failed", Loc::new(input_path, 1, 1, 1))
...
fn check_for_entry_point(types: &TypeMap, input_path: &String) -> Result<(), MocError> {
    if !types
        .iter()
...
mod functional {
    ...
    #[test]
    fn moc_enum() -> Result<(), std::io::Error> {
    ...
    #[test]
    fn moc_impl() -> Result<(), std::io::Error> {
    ...
    #[test]
    fn moc_struct() -> Result<(), std::io::Error> {
        super::test_tools::run_test("src/tests/functional", "struct", None)
    }

    #[test]
    fn moc_union() -> Result<(), std::io::Error> {
